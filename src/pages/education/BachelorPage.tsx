...
import BarLearnType from "../../components/dashboard/BarLearnType";
import BarPieByRegion from "../../components/dashboard/BarPieByRegion";
import TableGroup from "../../components/dashboard/TableGroup";
import useIncrementEffect from "../../hooks/useIncementEffect";
import { ThemeContext } from "../../theme/ThemeContext";
import PieByHours from "../../components/dashboard/PieByHours";
...
function BachelorPage() {
  ...
  return (
    ...
    >
      ...
      <section className="dark:bg-bodyBackgroundColor" ref={sectionRefs[0]}>
        <div className="px-4 py-3 mx-auto text-center lg:py-2">
          <dl className="grid gap-4 xl:gap-x-8 mx-auto text-gray-900 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6 dark:text-white">
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              <FontAwesomeIcon
                icon={faLayerGroup}
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 1, 100, 3)}
                </dt>
                <dd className="font-medium text-xl">
                  {t("bachelorpage.course")}
                </dd>
              </div>
            </div>
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 1, 100, 4)}
                </dt>
                <dd className="font-medium text-xl">
                  {t("bachelorpage.faculty")}
                </dd>
              </div>
            </div>
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 1, 50, statData?.chairs.cnt)}
                </dt>
                <dd className="font-medium text-xl">
                  {t("bachelorpage.chairs")}
                </dd>
              </div>
            </div>
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 1, 15, statData?.subjects.cnt)}
                </dt>
                <dd className="font-medium text-xl">
                  {t("bachelorpage.subjects")}
                </dd>
              </div>
            </div>
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 25, 20, 2301)}
                </dt>
                <dd className="font-medium text-xl">
                  {t("bachelorpage.students")}
                </dd>
              </div>
            </div>
            <div className="flex items-center justify-around bg-white dark:bg-slate-700 dark:hover:bg-toggleBackground cursor-pointer text-[#14059c] dark:text-white shadow-lg rounded-lg py-2 md:py-6 transition duration-500 ease-in border-b-8 border-[#14059c] dark:border-white hover:-translate-y-1 hover:scale-110">
              ...
              <div className="flex flex-col items-center">
                <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
                  {useIncrementEffect(0, 10, 50, statData?.teachers.cnt)}
                </dt>
                <dd className="font-medium text-xl line-clamp-1">
                  {t("bachelorpage.teachers")}
                </dd>
              </div>
            </div>
          </dl>
      ...
      <section className="px-2 md:px-4 py-3" id="chart">
        <ChartSection educationTypeId={11} educationFormId={11} />
      </section>

      <section className="px-2 md:px-4 py-3" ref={sectionRefs[1]}>
        <BarLearnType educationTypeId={11} />
      </section>

      <section className="px-2 md:px-4 py-3" ref={sectionRefs[2]}>
        <PieByHours educationTypeId={11} />
      </section>

      <section className="px-2 md:px-4 py-3" ref={sectionRefs[3]}>
        <BarPieByRegion educationTypeId={11} />
      </section>

      <section className="px-2 md:px-4 py-3" ref={sectionRefs[4]}>
        <TableGroup educationTypeId={11} educationFormId={11} />
      </section>
    </div>
  );
}
