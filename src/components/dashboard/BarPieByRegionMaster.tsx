      ...
      datasets: [
        {
          ...
          data: studentsAverage?.map((region: any) => {
            return region.avg_mark < 50 ? region.avg_mark : null;
          }),
        ...
        },
        {
          ...
          data: studentsAverage?.map((region: any) => {
            return region.avg_mark >= 50 && region.avg_mark < 70
              ? region.avg_mark
              : null;
          }),
        ...
        },
        {
          ...
          data: studentsAverage?.map((region: any) => {
            return region.avg_mark >= 70 && region.avg_mark < 85
              ? region.avg_mark
              : null;
          }),
        ...
        },
        {
          ...
          data: studentsAverage?.map((region: any) => {
            return region.avg_mark >= 85 ? region.avg_mark : null;
          }),
