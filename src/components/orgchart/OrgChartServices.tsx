...
import { depServices } from "../../utils/Requests";
            ...
            <thead className="sticky top-0 bg-[#14059c] dark:bg-toggleBackground text-md font-normal text-white dark:text-white">
              <tr>
                ...
                <th scope="col" className="px-2 py-3 text-center">
                  {t("structurepage.service_name") as string}
                </th>
              ...
              {services.map((service: any, index: number) => {
                return (
                  <tr className="border-b">
                    ...
                    <th className="text-left font-normal">{service.name}</th>
                    <th className="text-center font-normal ">{service.code}</th>
                  </tr>
                );
              })}
            </tbody>
