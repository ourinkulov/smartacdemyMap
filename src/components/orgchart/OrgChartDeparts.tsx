...
import { departs } from "../../utils/Requests";
              ...
              {units.map((unit: any, index: number) => {
                return (
                  <tr className="border-b">
                    ...
                    <th className="text-left font-normal">{unit.name}</th>
                    <th className="text-center font-normal ">{unit.code}</th>
                  </tr>
                );
              })}
            </tbody>
